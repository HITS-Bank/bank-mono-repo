    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("credit/loan/create").hasRole(Role.CLIENT.name())
                        .requestMatchers("credit/loan/list").hasRole(Role.CLIENT.name())
                        .requestMatchers("credit/employee/loan/*/list").hasRole(Role.EMPLOYEE.name())
                        .requestMatchers("credit/loan/*/pay").hasRole(Role.CLIENT.name())
                        .requestMatchers("credit/loan/*").authenticated()
                        .requestMatchers("credit/employee/loan/tariffs/create").hasRole(Role.EMPLOYEE.name())
                        .requestMatchers("credit/employee/loan/tariffs/*/delete").hasRole(Role.EMPLOYEE.name())
                        .requestMatchers("credit/loan/tariffs").authenticated()
                        .requestMatchers("credit/*").hasRole(Role.EMPLOYEE.name())
